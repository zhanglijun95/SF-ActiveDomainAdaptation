...
class DeformableDETR(nn.Module):
    ...
    def nms_inference(self, box_cls, box_pred, image_sizes):
        ...
        for i, (scores_per_image, labels_per_image, box_pred_per_image, image_size) in enumerate(
            ...
            # COCO DETA has 900 queries * 80 classes, so topk(10000) is valid.
            # DAOD Cityscapes has only 8 classes; clamp k to avoid evaluation
            # failures after replacing the classifier head.
            pre_topk = scores_per_image.topk(min(10000, scores_per_image.numel())).indices
